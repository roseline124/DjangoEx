...
from django.http import HttpResponse #0 FBV
from django.contrib.auth import views #1
from django.template.response import TemplateResponse #2
...
class BookDetailView(DetailView):
    ...
    context_object_name = 'book' # 디폴트 컨텍스트 변수명 :  object 이름 (book)